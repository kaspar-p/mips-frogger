...
.data	
	...
	screenBuffer: .space bufferSize
	# The buffer to write to, prevents flashing
	.globl frameBuffer
	frameBuffer: .space bufferSize
	...
	bluePlayerAnimationAddressArray: .space 64	# 16 words
	.globl pinkPlayerAnimationAddressArray
	pinkPlayerAnimationAddressArray: .space 64	# 16 words
	...
	pinkHeartColorArray: .word 	black,		black,		 black,			black,			black,			black,			black,		black,
					...
					black,		pinkHeartLight,  pinkHeartMid, 		pinkHeartMid, 		pinkHeartDark, 		pinkHeartDark, 		pinkHeartDark, 	black,
	...
	blueHeartColorArray: .word 	black,		black,		 black,			black,			black,			black,			black,		black,
					...
					black,		blueHeartLight,  blueHeartMid, 		blueHeartMid, 		blueHeartDark, 		blueHeartDark, 		blueHeartDark, 	black,
